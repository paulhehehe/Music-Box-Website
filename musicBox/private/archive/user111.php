...
<html lang="en">
    ...
    <div id="main-right">
            ...
            <form action="./addSongToPlaylist.php" method="post">
                <div class="tracks-container">
                    ...
                    <div class="track-item-title">
                        <span class="track-name-title">Track Name</span>
                        <span class="artist-name-title">Artist Name</span>
                        <span class="popularity-title">Popularity</span>
                        <span class="release-date-title">Release Date</span>
                        <span class="add-track-switch-title">Select</span>
                    </div>
        ...
        `;
                ...
                <button type="submit" class="confirm-add-btn">Confirm Add</button>
            </form>
        </section>
    </div>
</main>
